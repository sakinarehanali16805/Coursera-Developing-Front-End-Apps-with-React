...
const ConferenceEvent = () => {
  ...
  const remainingAuditoriumQuantity =
    3 - venueItems.find((item) => item.name === "Succulent Plant").quantity;
  ...
  const handleAddToCart = (index) => {
    if (
      venueItems[index].name === "Succulent Plant" &&
          ...
          <div className="items-information">
            ...
            <div id="meals" className="venue_container container_main">
              <div className="text">
                ...
                <h2>Our shop provide organic meal and take-away option</h2>
              </div>
